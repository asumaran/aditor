    ...
    return (
      <div className={cn('space-y-2', className)} data-block-id={blockId}>
        <div
          ...
          className={cn(
            'min-h-[1em] w-fit max-w-full cursor-text rounded-md px-[10px] text-[24px] leading-[30px] font-bold break-words whitespace-break-spaces text-[rgb(50,48,44)] caret-[rgb(50,48,44)] focus:outline-none mb-[10px]',
